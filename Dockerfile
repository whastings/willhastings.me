...
RUN npm install @whastings/js_utils@^0.4.1
RUN npm install autobind-decorator@^1.3.3
RUN npm install babel-core@^6.4.0
RUN npm install babel-loader@^6.2.1
RUN npm install babel-plugin-transform-decorators-legacy@^1.3.4
RUN npm install babel-plugin-transform-es2015-modules-commonjs@^6.4.0
RUN npm install babel-plugin-transform-object-rest-spread@^6.5.0
